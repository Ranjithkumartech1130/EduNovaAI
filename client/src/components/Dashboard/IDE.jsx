    ...
    return (
        <div className="ide-overlay">
                                ...
                                <div>
                                    ...
                                    <div className={`algo-result-card ${algoResult.status === 'correct' ? 'correct' : algoResult.status === 'error' ? '' : 'incorrect'}`}>
                                        <div className={`algo-status-badge ${algoResult.status === 'correct' ? 'correct' : 'incorrect'}`}>
                                            ...
                                            {algoResult.status === 'correct' ? '✓ Correct Algorithm' : algoResult.status === 'error' ? '⚠ Connection Error' : '✗ Incorrect Algorithm'}
                                        </div>
                                    ...
                                    {taskRelevance && !taskRelevance.relevant && (
                                        <div style={{
                                    ...
                                    {taskRelevance && taskRelevance.relevant && taskRelevance.message && (
                                        <div style={{
                                            marginBottom: 15, padding: '10px 14px', borderRadius: '8px',
            ...
            <div className="ide-footer">
                <span>SkillGPS IDE • AI Algorithm Instructor • {LANGUAGES.length} Languages</span>
                <span>Press <kbd>Esc</kbd> to close • <kbd>Ctrl+Enter</kbd> to run • <kbd>Ctrl+Enter</kbd> in algo panel to analyze</span>
            </div>
